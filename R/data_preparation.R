...
#Plot, using the leapfrog_scatter_plot function (in visualization.R) by income group
...
#PLot 2, using the leapfrog_scatter_plot_by_region function (representation by region)
